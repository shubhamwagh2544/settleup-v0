...
class AccountService {
    ...
    async getAccountTransactions(accountId: number) {
        ...
        // Fetch only transactions that belong to this account with correct direction
    ...
    async deleteAccount(accountId: number) {
        ...
        const hasPendingTransactions = account.sentTransactions.length > 0 || account.receivedTransactions.length > 0;
